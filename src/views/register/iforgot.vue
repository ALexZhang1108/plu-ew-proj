    ...
    <div class="content-container">
      ...
      <el-form ref="loginForm" :model="registerForm" :rules="registerRules" class="register-form" autocomplete="on" label-position="left">
        ...
        <div class="iforgot-container1">
          <h4 class="iforgot-title">Forgot your password ?</h4>
        </div>

        <div class="iforgot-container2">
          <h5 class="iforgot-content">Enter your e-mail address and we’ll send you a link to reset your password.</h5>
        </div>
        ...
        <el-button :type="primary" class="content-button" @click.native.prevent="handleLogin">Reset Password</el-button>
      </el-form>
